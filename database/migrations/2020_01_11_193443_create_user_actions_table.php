...
class CreateUserActionsTable extends Migration {
	...
	public function up()
	{
		...
		{
			$table->increments('id');
			$table->unsignedInteger('user_id')->nullable()->index('act_user_fk');
			$table->unsignedInteger('action_id')->nullable()->comment('The ID of the item being worked on, e.g. jobsheet_id');
