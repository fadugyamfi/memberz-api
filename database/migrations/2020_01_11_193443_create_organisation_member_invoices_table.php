...
class CreateOrganisationMemberInvoicesTable extends Migration {
	...
	public function up()
	{
		Schema::create('organisation_member_invoices', function(Blueprint $table)
		{
			$table->increments('id');
			$table->integer('organisation_id')->unsigned()->nullable()->index('organisation_id');
			$table->integer('organisation_member_id')->unsigned()->nullable()->index('member_account_id');
	...
	{
		Schema::drop('organisation_member_invoices');
	}
