    ...
    */
    ...
    'connections' => [
        ...
        'support_mysql' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('SUPPORT_DB_HOST', '127.0.0.1'),
            'port' => env('SUPPORT_DB_PORT', '3306'),
            'database' => env('SUPPORT_DB_DATABASE', 'forge'),
            'username' => env('SUPPORT_DB_USERNAME', 'forge'),
            'password' => env('SUPPORT_DB_PASSWORD', ''),
            'unix_socket' => env('SUPPORT_DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
