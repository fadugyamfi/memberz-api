 ...
 */
     ...
     */ 
         ...
         * @static 
         */ 
        public static function createElasticemailTransport()
        {
                        /** @var \FlexFlux\LaravelElasticEmail\MailManager $instance */
                        return $instance->createElasticemailTransport();
        }
                    /**
         ...
         * @param string $driver
         * @param \Closure $callback
         * @return \FlexFlux\LaravelElasticEmail\MailManager 
         * @static 
         */ 
        public static function extend($driver, $callback)
        {            //Method inherited from \Illuminate\Mail\MailManager         
     ...
     */ 
        ...
        {
                        /** @var \LaravelApiBase\Services\ApiRouter $instance */
        ...
        {            //Method inherited from \Illuminate\Routing\Router         
                        return \LaravelApiBase\Services\ApiRouter::toResponse($request, $response);
        }
                    /**
         ...
         * @param string $name
         * @param string $class
         * @return \LaravelApiBase\Services\ApiRouter 
         * @static 
         */ 
        ...
        {            //Method inherited from \Illuminate\Routing\Router         
                        return \LaravelApiBase\Services\ApiRouter::uniqueMiddleware($middleware);
        }
                    /**
        ...
        public static function macro($name, $macro)
        {            //Method inherited from \Illuminate\Routing\Router         
                        \LaravelApiBase\Services\ApiRouter::macro($name, $macro);
        }
                    /**
         * Mix another object into the class.
         *
        ...
        public static function mixin($mixin, $replace = true)
        {            //Method inherited from \Illuminate\Routing\Router         
                        \LaravelApiBase\Services\ApiRouter::mixin($mixin, $replace);
        }
                    /**
         * Checks if macro is registered.
         *
        ...
        public static function hasMacro($name)
        {            //Method inherited from \Illuminate\Routing\Router         
                        return \LaravelApiBase\Services\ApiRouter::hasMacro($name);
        }
                    /**
         * Flush the existing macros.
         *
        ...
        public static function flushMacros()
        {            //Method inherited from \Illuminate\Routing\Router         
                        \LaravelApiBase\Services\ApiRouter::flushMacros();
        }
                    /**
         * Dynamically handle calls to the class.
         *
...
')
     ...
     */ 
        ...
        {
                        /** @var \NunoMazer\Samehouse\TenantManager $instance */
                        $instance->enable();
        }
                    /**
         ...
         *
         * @param \Illuminate\Database\Eloquent\Model|\NunoMazer\Samehouse\BelongsToTenants $model
         * @static 
         */ 
        ...
        public static function macro($name, $macro)
        {
                        \NunoMazer\Samehouse\TenantManager::macro($name, $macro);
        }
                    /**
         * Mix another object into the class.
         *
        ...
        public static function mixin($mixin, $replace = true)
        {
                        \NunoMazer\Samehouse\TenantManager::mixin($mixin, $replace);
        }
                    /**
         * Checks if macro is registered.
         *
        ...
        public static function hasMacro($name)
        {
                        return \NunoMazer\Samehouse\TenantManager::hasMacro($name);
        }
                    /**
         * Flush the existing macros.
         *
        ...
        public static function flushMacros()
        {
                        \NunoMazer\Samehouse\TenantManager::flushMacros();
        }
...
namespace  { 
            ...
            class Landlord extends \NunoMazer\Samehouse\Facades\Landlord {}
